...
contract BalancerFlashLoan is IFlashLoanRecipient, IFlashLoanProvider {
    ...
    function makeFlashLoan(IERC20 _token, uint256 _amount, Operation _operation, bytes calldata _params) external {
        ...
        if (_operation == Operation.OpenTrove) {
            ILeverageZapper.OpenLeveragedTroveParams memory openTroveParams = abi.decode(
                _params,
            ...
            ILeverageZapper.LeverUpTroveParams memory leverUpTroveParams = abi.decode(
                _params,
            ...
            ILeverageZapper.LeverDownTroveParams memory leverDownTroveParams = abi.decode(
                _params,
