...
contract DeployGovernance is Script {
    ...
    function deployGovernance(
        ...
        (
            ...
            IGovernance.Configuration memory governanceConfiguration
    ...
    function computeGovernanceAddressAndConfig(
        DeployGovernanceParams memory p
    ) internal pure returns (address, IGovernance.Configuration memory) {
            ...
            string.concat(
                ...
                string.concat(
                    ...
                    string.concat(
                        ...
                        UNREGISTRATION_THRESHOLD_FACTOR.toString(),
                        '",'
                    ),
