...
import {ETH_GAS_COMPENSATION, MAX_ANNUAL_INTEREST_RATE, MIN_ANNUAL_INTEREST_RATE, MIN_INTEREST_RATE_CHANGE_PERIOD} from "src/Dependencies/Constants.sol";
...
contract OpenTroves is Script {
    ...
    ) internal view returns (uint256 upperHint, uint256 lowerHint) {
