...
contract SPTest is DevTestSetup {
    ...
    function testProvideToSPNoClaimAddsBOLDGainsToDeposit() public {
        ...
        assertApproximatelyEqual(
            ...
            depositBefore_A + topUp + currentBoldGain,
            1e4
        );
    }
    ...
    function testProvideToSPNoClaimAddsBoldGainsToTotalBoldDeposits() public {
        ...
        assertApproximatelyEqual(
            ...
            totalBoldDepositsBefore + topUp + currentBoldGain,
            1e4
        );
    }
    ...
    function testWithdrawFromSPNoClaimAddsBOLDGainsToDeposit() public {
        ...
        assertApproximatelyEqual(
            stabilityPool.getCompoundedBoldDeposit(A),
            depositBefore_A - withdrawal + currentBoldGain,
            1e4
        );
    }
    ...
    function testGetDepositorBoldGain_2SPDepositor2RewardEvent_EarnFairShareOfSPYield() public {
        ...
        assertApproximatelyEqual(
            ...
            expectedShareOfReward1_A + expectedShareOfReward2_A,
            1e4
        );
        assertApproximatelyEqual(
            stabilityPool.getDepositorYieldGain(B),
            expectedShareOfReward1_B + expectedShareOfReward2_B,
            1e4
        );
    }
    ...
    function testGetDepositorBoldGain_2SPDepositor1Liq1FreshDeposit_EarnFairShareOfSPYield() public {
        ...
        // Confirm the expected shares sum up to the total expected yield
        assertApproximatelyEqual(
            expectedShareOfReward2_A + expectedShareOfReward2_B + expectedShareOfReward2_C,
            expectedSpYield_2,
            1e4
        );
    ...
    function testGetDepositorBoldGain_2SPDepositor2LiqScaleChangesFreshDeposit_EarnFairShareOfSPYield() public {
        ...
        assertApproximatelyEqual(
            stabilityPool.getDepositorYieldGain(A),
            expectedShareOfReward[1].A + expectedShareOfReward[2].A,
            1e14,
            "2"
        );
    ...
    function testLiquidationsWithLowPAllowFurtherRewardsForAllFreshDepositors_Cheat_Fuzz(
        ...
        assertApproximatelyEqual(
            testVars.expectedShareOfYield1_C,
            testVars.boldGainC,
            1e6,
            "C share of yield mismatch"
        );
        assertApproximatelyEqual(
            testVars.expectedShareOfYield1_D,
            testVars.boldGainD,
            1e6,
            "D share of yield mismatch"
        );
    ...
    function testLiquidationsWithLowPAllowFurtherRewardsForAllFreshDepositors_Cheat_Fixed() public {
        testLiquidationsWithLowPAllowFurtherRewardsForAllFreshDepositors_Cheat_Fuzz(
            2371624267,
            555740272250686904193353073666173923435456188015
        );
    }
    ...
    function testLiquidationsWithLowPAllowFurtherRewardsForExistingDepositors(
        uint256 _cheatP,
        uint256 _surplus
    ) public {
        PTestVars memory testVars;
        ...
        testVars.expectedDeposit1_A =
            testVars.deposit1_A -
            (testVars.deposit1_A * testVars.troveDebt_C) /
            testVars.totalSPBeforeLiq_C;
        testVars.expectedDeposit1_B =
            testVars.deposit1_B -
            (testVars.deposit1_B * testVars.troveDebt_C) /
            testVars.totalSPBeforeLiq_C;
        ...
        testVars.expectedDeposit2_A =
            testVars.deposit2_A -
            (testVars.deposit2_A * testVars.troveDebt_D) /
            testVars.totalSPBeforeLiq_D;
        testVars.expectedDeposit2_B =
            testVars.deposit2_B -
            (testVars.deposit2_B * testVars.troveDebt_D) /
            testVars.totalSPBeforeLiq_D;
    ...
    function testLiqDebtWithin1BoldOfTotalDepositsSplitsCollGainsCorrectly_Fuzz() public {
        ...
        assertApproxEqAbs(
            troveManager.getTroveEntireColl(troveIdA) - vars.collABefore,
            vars.collToRedist,
            10,
            "Incorrect coll to A"
        );
