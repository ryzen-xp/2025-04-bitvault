...
contract AnchoredInvariantsTest is Logging, BaseInvariantTest, BaseMultiCollateralTest, TroveId {
    ...
    function testWrongYield() external {
        ...
        handler.openTrove(
            0,
            99_999.999999999999999997 ether,
            2.251600954885856105 ether,
            0.650005595391858041 ether,
            8768,
            0
        );
        ...
        handler.registerBatchManager(
            1,
            0.995000004199127012 ether,
            1 ether,
            0.999139502777974999 ether,
            0.059938454189132239 ether,
            1706585
        );
    ...
    function testRedeemUnderflow() external {
        ...
        handler.openTrove(
            3,
            39_503.887731534058892956 ether,
            1.6863644596244192 ether,
            0.38385567397413886 ether,
            1,
            7433679
        );
    ...
    function testWrongYieldPrecision() external {
        ...
        handler.openTrove(
            1,
            99_999.999999999999999998 ether,
            1.883224555937797003 ether,
            0.887905235895642125 ether,
            4164477,
            39
        );
        ...
        handler.openTrove(
            3,
            30_260.348082017558572105 ether,
            1.683511222023706186 ether,
            0.016900375815455486 ether,
            108,
            14159
        );
    ...
    function testSortedTroveSize() external {
        ...
        handler.openTrove(
            1,
            7_591.289850943621327156 ether,
            1.900000000017470971 ether,
            0.812103428106344175 ether,
            1121,
            415425919
        );
        ...
        handler.openTroveAndJoinInterestBatchManager(
            2,
            73_312.036791249214758342 ether,
            1.900020510596646286 ether,
            40,
            115,
            737
        );
        ...
        handler.openTroveAndJoinInterestBatchManager(
            3,
            25_307.541971224954454066 ether,
            2.401194840294921108 ether,
            142,
            6432363,
            25223
        );
        ...
        handler.openTrove(
            0,
            40_510.940914935073773948 ether,
            2.063402456659389908 ether,
            0.995000000000000248 ether,
            0,
            55487655
        );
    ...
    function testAssertLastZombieTroveInABatchHasMoreThanMinDebt() external {
        ...
        handler.openTroveAndJoinInterestBatchManager(
            1,
            12_654.280610244006254376 ether,
            2.145058504746006382 ether,
            182,
            22444926,
            124118903
        );
        ...
        handler.openTrove(
            0,
            32_721.264734011072612096 ether,
            2.333153121000516764 ether,
            0.995000000000109949 ether,
            52719,
            31482
        );
        ...
        handler.openTrove(
            0,
            3_111.607048463492852195 ether,
            1.16895262626418546 ether,
            0.142852735597140811 ether,
            1885973,
            10937
        );
        ...
        handler.registerBatchManager(
            1,
            0.995000000000001129 ether,
            1 ether,
            0.999999999999799729 ether,
        ...
        handler.openTroveAndJoinInterestBatchManager(
            1,
            66_969.454138225567397381 ether,
            2.984784797753777921 ether,
            4294967294,
            1,
            52
        );
        ...
        handler.openTroveAndJoinInterestBatchManager(
            0,
            96_538.742068715532219745 ether,
            2.762063859567414329 ether,
            0,
            61578232,
            336273331
        );
