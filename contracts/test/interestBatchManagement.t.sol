...
contract InterestBatchManagementTest is DevTestSetup {
    ...
    function testSetsBatchManagerProperlyOnOpen() public {
        ...
        IBorrowerOperations.InterestBatchManager memory batchManager = borrowerOperations.getInterestBatchManager(
            batchManagerAddress
        );
    ...
    function testSetBatchManagerRemovesIndividualDelegate() public {
        ...
        IBorrowerOperations.InterestIndividualDelegate memory delegate = borrowerOperations
    ...
    function testLowerBatchManagementFee() public {
        ...
        assertEq(
            ...
            "Batch recorded debt should be equal to entire"
        );
    ...
    function testSwitchFromOldToNewBatchManager() public {
        ...
        assertGt(
            troveEntireDebtBefore.A,
            troveRecordedDebtBefore.A,
            "Trove A entire debt should be greater than recorded"
        );
        ...
        assertGt(
            troveEntireDebtBefore.D,
            troveRecordedDebtBefore.D,
            "Trove D entire debt should be greater than recorded"
        );
        ...
        assertGt(
            troveEntireDebtBefore.E,
            troveRecordedDebtBefore.E,
            "Trove E entire debt should be greater than recorded"
        );
        ...
        assertGt(
            batchEntireDebtBefore.B,
            batchRecordedDebtBefore.B,
            "Batch B entire debt should be greater than recorded"
        );
        ...
        assertGt(
            batchEntireDebtBefore.C,
            batchRecordedDebtBefore.C,
            "Batch C entire debt should be greater than recorded"
        );
        ...
        assertApproxEqAbs(
            ...
            troveEntireDebtBefore.A,
            10,
            "Interest was not applied to trove A"
        );
        assertEq(
            troveManager.getTroveDebt(troveIDs.A),
        ...
        assertApproxEqAbs(
            ...
            troveEntireDebtBefore.D,
            1,
            "Interest was not applied to trove D"
        );
        assertEq(
            troveManager.getTroveDebt(troveIDs.D),
    ...
    function testApplyBatchInterestPermissionlessReinsertsIntoSortedTrovesIfInBatch() public {
        ...
        assertEq(
            uint8(troveManager.getTroveStatus(ATroveId)),
            uint8(ITroveManager.Status.active),
            "A should not be zombie"
        );
        assertEq(sortedTroves.contains(ATroveId), true, "SortedTroves should have trove A ");
        assertEq(sortedTroves.isBatchedNode(ATroveId), true, "A should be batched in SortedTroves");
    ...
    function testSwitchBatchManagerBackAndForthCannotBeUsedToDo2ConsecutiveChangesForFree() public {
        ...
        assertEq(
            ...
            block.timestamp,
            "Wrong interest rate adj time for A after first switch"
        );
        ...
        assertEq(
            troveManager.getTroveEntireDebt(troveId),
            ADebtBefore,
            "A debt should not increase after first batch adjust"
        );
        ...
        assertEq(
            troveData.lastInterestRateAdjTime,
            block.timestamp,
            "Wrong interest rate adj time for A after second switch"
        );
    ...
    function testOpenTroveAndJoinBatchManagerChargesProperUpfrontFeeSimple() public {
        ...
        uint256 expectedUpfrontFeeA = (initialDebt * interestRate * UPFRONT_INTEREST_PERIOD) /
            ONE_YEAR /
            DECIMAL_PRECISION;
        ...
        uint256 expectedUpfrontFeeC = (initialDebt * interestRate * UPFRONT_INTEREST_PERIOD) /
            ONE_YEAR /
            DECIMAL_PRECISION;
    ...
    function testOpenTroveAndJoinBatchManagerChargesProperUpfrontFeeWithDifferentInterestRates() public {
        ...
        uint256 expectedUpfrontFeeA = (initialDebt * avgInterestRate * UPFRONT_INTEREST_PERIOD) /
            ONE_YEAR /
            DECIMAL_PRECISION;
        assertEq(ATroveEntireDebt - initialDebt, expectedUpfrontFeeA, "Wrong upfront fee for A");
        ...
        avgInterestRate =
            (DWeightedDebt + (ATroveEntireDebt + initialDebt) * interestRate) /
            (DTroveEntireDebt + ATroveEntireDebt + initialDebt);
        uint256 expectedUpfrontFeeC = (initialDebt * avgInterestRate * UPFRONT_INTEREST_PERIOD) /
            ONE_YEAR /
            DECIMAL_PRECISION;
