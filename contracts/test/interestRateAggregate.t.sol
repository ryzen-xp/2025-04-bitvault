...
contract InterestRateAggregate is DevTestSetup {
    ...
    function testCalcPendingAggInterestReturnsCorrectInterestForGivenPeriod() public {
        ...
        uint256 expectedPendingAggInterest = Math.ceilDiv(
            (debt_A * interestRate_A + debt_B * interestRate_B) * _duration,
    ...
    function testGetEntireSystemDebtWithNoRedistGainsReturnsSumOfTroveRecordedDebtsPlusIndividualInterests() public {
        ...
        uint256 sumIndividualTroveDebts = recordedDebt_A +
            accruedInterest_A +
            recordedDebt_B +
            accruedInterest_B +
            recordedDebt_C +
    ...
    function testRedemptionWithNoRedistGainsChangesWeightedDebtSumCorrectly() public {
        ...
        uint256 expectedAggWeightedRecordedDebt = aggWeightedDebtSum_1 +
            newWeightedRecordedDebt_A +
            newWeightedRecordedDebt_B -
            oldWeightedRecordedDebt_A -
