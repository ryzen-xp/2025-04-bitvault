...
contract ShutdownTest is DevTestSetup {
    ...
    function testCanUrgentReedemFullyBelow100() external {
        ...
        assertEq(
            ...
            boldBalanceBefore -
                (((11e18 * price) / DECIMAL_PRECISION) * DECIMAL_PRECISION) /
    ...
    function testUrgentRedemptionReducesAggWeightedDebtSumByNetWeightedAmountRemoved() public {
        ...
        uint256 netWeightedDebtRemoved = (redemptionAmount - interest_t3) *
            troveManager.getTroveAnnualInterestRate((troveId3));
