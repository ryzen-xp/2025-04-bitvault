...
contract Redemptions is DevTestSetup {
    ...
    function testRedemption1TroveLeavesCollFeeInTrove() public {
        ...
        uint256 expectedRemainingColl = troveManager.getTroveEntireColl(troveIDs.B) -
            correspondingColl +
            predictedCollFee;
    ...
    function testRedemption3TroveLeavesCollFeesInTroves() public {
        ...
        uint256 expectedRemainingColl_A = troveManager.getTroveEntireColl(troveIDs.A) -
            correspondingColl.A +
            predictedCollFee_A;
        uint256 expectedRemainingColl_B = troveManager.getTroveEntireColl(troveIDs.B) -
            correspondingColl.B +
            predictedCollFee_B;
        uint256 expectedRemainingColl_C = troveManager.getTroveEntireColl(troveIDs.C) -
            correspondingColl.C +
            predictedCollFee_C;
